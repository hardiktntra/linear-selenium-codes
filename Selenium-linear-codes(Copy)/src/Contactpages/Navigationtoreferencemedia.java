...
public class Navigationtoreferencemedia {
	...
	//Navigation to Reference Media listing page
		Thread.sleep(2000);
		
		WebElement Ref=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='Reference Media']"));  //Element For Designation
		act.moveToElement(Ref).click().perform();
