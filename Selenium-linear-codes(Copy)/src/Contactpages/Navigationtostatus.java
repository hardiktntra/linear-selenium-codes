...
public class Navigationtostatus {
	...
	//Navigation to Status listing page
		Thread.sleep(2000);
		
		WebElement status=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='Status']"));  //Element For Designation
