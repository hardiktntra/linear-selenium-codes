...
public class Navigationtostatespage {
	...
	//Navigation to state listing page
		Thread.sleep(2000);
		
		WebElement state=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='States']"));  //Element For Designation
