...
public class Navigatetocitypage {
	...
	//Navigation to city listing page
		Thread.sleep(2000);
		
		WebElement city=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='City']"));  //Element For Designation
