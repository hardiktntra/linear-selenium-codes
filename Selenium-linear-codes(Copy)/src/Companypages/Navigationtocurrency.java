...
public class Navigationtocurrency {
	...
	//Hover on Contact
		...
		WebElement company=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='Company']")); //Element for Employee
		act.moveToElement(company).perform();
	

	
		
	//Navigation to Currency listing page
		Thread.sleep(2000);
		
		WebElement currency=driver.findElement(By.xpath("//span[@class='ant-menu-title-content'][normalize-space()='Currency']"));  //Element For Designation
